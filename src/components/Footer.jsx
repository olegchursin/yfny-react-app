...
export default () => {
  return (
    <div style={styles.footerWrapper}>
      <div>
        {yfny.socialMedia.hashtag}/ {yfny.socialMedia.nametag}
      </div>
      <div>{rcny.email}</div>
      <div style={styles.socialMediaGroup}>
        <a style={styles.socialMediaLink} href={yfny.socialMedia.facebook}>
          <FontAwesomeIcon
            style={styles.socialMediaIcon}
            icon={faFacebookSquare}
          />
        </a>
        <a style={styles.socialMediaLink} href={yfny.socialMedia.instagram}>
          <FontAwesomeIcon style={styles.socialMediaIcon} icon={faInstagram} />
        </a>
        <a style={styles.socialMediaLink} href={yfny.socialMedia.twitter}>
          <FontAwesomeIcon
            style={styles.socialMediaIcon}
      ...
      <div style={styles.webDevSection}>
        web dev //
        <a
